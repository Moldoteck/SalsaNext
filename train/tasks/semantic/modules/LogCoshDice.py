...
def true_log_cosh_dice(probas, labels, classes='present', per_image=False, ignore=None):
    """
    ...
    """
    loss = log_cosh_dice_flat(*flatten_probas(probas, labels, ignore), classes=classes)
    return loss

def log_cosh_dice_flat(probas, labels, classes='present'):
    """
    Multi-class Lovasz-Softmax loss
...
class LogCoshDice(nn.Module):
    ...
    def forward(self, probas, labels):
        return true_log_cosh_dice(probas, labels, self.classes, self.per_image, self.ignore)
